...
class MainView extends HBox {
    public function new() {
        ...
        ViewManager.instance.registerView({ group: "Containers", title: "List Views", smallIcon: "icons/16/list_box.png", largeIcon: "icons/32/list_box.png", viewClass: ListViewsView, relevantFiles: ["views/listviews.xml", "src/views/ListViewsView.hx"] });
            ...
            ViewManager.instance.registerView({ group: "Containers", subGroup:"List Views", title: "Code Item Renderer", smallIcon: "icons/16/labels.png", largeIcon: "icons/32/labels.png", viewClass: ListViewCodeItemRenderer, relevantFiles: ["views/listview-code-item-renderer.xml", "src/custom/MyListViewItemRenderer.hx", "src/views/ListViewCodeItemRenderer.hx"] });
        ...
        ViewManager.instance.registerView({ group: "Containers", title: "Collapsible", smallIcon: "icons/16/accordion.png", largeIcon: "icons/32/accordion.png", viewClass: CollapsibleView, relevantFiles: ["views/collapsible.xml"] });
        ...
        ViewManager.instance.registerView({ group: "Miscellaneous", title: "Filters", smallIcon: "icons/16/images.png", largeIcon: "icons/32/images.png", viewClass: FiltersView, relevantFiles: ["views/filters.xml", "src/views/FiltersView.hx"] });
            ViewManager.instance.registerView({ group: "Miscellaneous", subGroup: "Filters", title: "Neon Buttons", smallIcon: "icons/16/images.png", largeIcon: "icons/32/images.png", viewClass: NeonButtonsView, relevantFiles: ["views/neon-buttons.xml", "src/views/NeonButtonsView.hx"] });
